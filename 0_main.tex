...
\title[Origines et progrès du projet Charcot]{\fontsize{13pt}{13pt}\selectfont Origines et progrès du projet Charcot}
...
\date[Variation linguistique$\dots$, 12/09/2024]{\scriptsize Séminaire \og{}Variation linguistique et Linguistique Computationnelle\fg{} \\ -- Rencontres Minutes --\\Maison de la recherche, salle 117\\Paris, le 12 septembre 2024}
\usepackage{YTU}
...
%\input{objectif}
\input{intertextualite}


\section[\textit{Timeline} du projet]{Timeline du projet}
\input{timeline}
